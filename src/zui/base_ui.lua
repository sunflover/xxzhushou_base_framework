...
function GetUI()
	...
	pageTestting:nextLine()
	pageTestting:addLabel({text="根据球员状态自动换人，支持崩溃自动重启续接任务  ",size=20, align="cnter"})
	pageTestting:nextLine()
	pageTestting:addLabel({text="        目前为测试期，功能陆续添加中。关于分辨率的问题，目前只适配了16:9 ",size=20, align="cnter"})
	pageTestting:nextLine()
	pageTestting:addLabel({text="的比例，在功能完善后会增加部分其他比例的比例，请其他比例分辨率用户暂 ",size=20, align="cnter"})
	pageTestting:nextLine()
