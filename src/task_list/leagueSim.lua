...
local taskLeagueSim = {
	...
	process = {
		...
		{name = PAGE_LEAGUE, allowSkip = true, justFirstRun = true},
...
funcList[PAGE_LEAGUE_SIM] = function()
	--可跳过余下比赛
	if page.matchColors("510|501|0xcaddf0,510|522|0xcaddf0,677|511|0xcaddf0,705|506|0xcaddf0") then
...
funcList[PAGE_LEAGUE_SCOUT] = function()
	...
	while true do
		local nextPage = page.catchFewProbabilityPage(PAGE_LEAGUE_SIM,	--可能续约教练和球员
			...
			"206|105|0x13304d,450|165|0xffa2a8,509|166|0xffffff,485|199|0xff3261,440|404|0xcaddf0,445|450|0xf5f5f5"})--球员续约
		...
		elseif nextPage == 0 then	--已经返回到教练模式主界面
			break
		end
